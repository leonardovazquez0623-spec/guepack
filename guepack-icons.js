// GUEPACK — Sistema de iconos "todo gira alrededor del gato"
// Sin orejitas decorativas en ningún ícono — la identidad "gato" vive en
// bigotes, huellas y la cola de guepardo.
// Colores de marca: azul #1E56C7 (estructura), naranja #F05A1A (acento),
// verde #2FAE5C (entregado), dorado #F0B429 (premio)
...
<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  // 🚚 Repartidor → Gato con mochila GuePack
  repartidor: `
<svg viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
  <circle cx="28" cy="20" r="10" stroke="#1E56C7" stroke-width="2.5"/>
  <path d="M20 12 L17 5 L23 10" stroke="#1E56C7" stroke-width="2.5" stroke-linejoin="round"/>
  <path d="M36 12 L39 5 L33 10" stroke="#1E56C7" stroke-width="2.5" stroke-linejoin="round"/>
  <path d="M23 21 Q28 25 33 21" stroke="#F05A1A" stroke-width="2" stroke-linecap="round" fill="none"/>
  <circle cx="24" cy="18" r="1.3" fill="#1E56C7"/>
  <circle cx="32" cy="18" r="1.3" fill="#1E56C7"/>
  <rect x="18" y="32" width="20" height="16" rx="4" stroke="#F05A1A" stroke-width="2.5"/>
  <path d="M18 38 L12 36 L12 46 L18 44" stroke="#F05A1A" stroke-width="2.2" stroke-linejoin="round" fill="none"/>
</svg>`,
...
<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  // ⏳ Esperando → Cola de guepardo enroscada en círculo, naranja con manchas
  esperando: `
<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
