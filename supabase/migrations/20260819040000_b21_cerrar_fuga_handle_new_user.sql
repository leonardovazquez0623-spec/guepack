...
-- Promovido desde supabase/drafts/b21_cerrar_fuga_handle_new_user.sql tras
-- verificar en producción: sin drift contra pg_get_functiondef() de
-- handle_new_user()/auto_asignar_rol_cliente(), sin duplicados en
-- usuarios.user_id ni tenants.dominio, y sin perfiles con tenant
-- inconsistente respecto a sus membresías (0 filas) — 2026-08-19.
--
